...
QT_MOC_LITERAL(3, 20, 13), // "workRequested"
QT_MOC_LITERAL(4, 34, 6) // "doWork"

    },
    "OptThread\0finished\0\0workRequested\0"
    "doWork"
};
...
void OptThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (OptThread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptThread::finished)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (OptThread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptThread::workRequested)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject OptThread::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_OptThread.data,
...
// SIGNAL 0
void OptThread::finished()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void OptThread::workRequested()
{
